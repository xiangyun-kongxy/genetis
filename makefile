...
flagext := -DLEVELDB_PLATFORM_POSIX -I/usr/local/include/c++/6.4.0 -std=gnu++11 -I/usr/local/lib/wx/include/gtk2-unicode-3.1 -I/usr/local/include/wx-3.1 -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXGTK__
libext :=so
uselib :=-lpthread -luuid -ldl -pthread   -lwx_gtk2u_xrc-3.1 -lwx_gtk2u_html-3.1 -lwx_gtk2u_qa-3.1 -lwx_gtk2u_adv-3.1 -lwx_gtk2u_core-3.1 -lwx_baseu_xml-3.1 -lwx_baseu_net-3.1 -lwx_baseu-3.1
uselibpath :=-L/usr/local/lib64 -L/usr/local/lib
else 
ifeq ($(shell uname), Darwin)
flagext := -DLEVELDB_PLATFORM_POSIX -DOS_MACOSX -Wno-deprecated-declarations -std=gnu++11 -stdlib=libc++ -I/usr/local/lib/wx/include/osx_cocoa-unicode-3.1 -I/usr/local/include/wx-3.1 -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXMAC__ -D__WXOSX__ -D__WXOSX_COCOA__ -D_WCHAR_H_CPLUSPLUS_98_CONFORMANCE_
libext :=dylib
